...
prompt_for_deadline="Current Date :"+str(date.today())+"Give a random deadline for a task. The deadline should not be beyond 1 month from current date. Output in the format: DD-MM-YYYY HH:MM  Dont return anything else, just return the string:  \"DD=MM-YYYY HH:MM\""
def askLLM(prompt):
